...
# ===== GENERAR ARCHIVO TXT CON INFORME (VERSIÓN SEGURA) =====
    ...
    with open(nombre_archivo, "w", encoding="utf-8") as f:
        ...
        for i, fila in df.iterrows():
            ...
            for campo, etiqueta in {
                ...
                "Bajas_Ultimo_Año": "Bajas Último Año",
                "Promociones_2_Años": "Promociones en 2 Años",
                "Prob_Abandono": "Probabilidad de Abandono",
                "Recomendación": "Recomendación"
            }.items():
                if campo in columnas:
                    valor = fila[campo]
                    if campo == "Prob_Abandono":
                        valor = f"{int(valor*100)}%"
                    elif campo in ["Edad", "Antigüedad"]:
                        valor = f"{int(valor)} años"
                    elif campo == "Horas_Extra":
                        valor = f"{valor}h"
