...
with col1:
    with open("CSV_EJEMPLO_DESCARGA.csv", "rb") as f:
        st.download_button("📂 Descargar CSV de ejemplo", f, file_name="datos_empleados_ejemplo.csv", mime="text/csv")
with col2:
    with open("manual_usuario_TFG.pdf", "rb") as f:
        st.download_button("📘 Descargar Manual de Usuario (PDF)", f, file_name="manual_usuario_TFG.pdf", mime="application/pdf")
