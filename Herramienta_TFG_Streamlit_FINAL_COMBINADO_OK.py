    ...
    if df_filtered.empty:
        ...
        with col_top:
            ...
            for index, row in top_5_risk.iterrows():
                st.markdown(f"**{row['Nombre']}** ({row['Departamento']}) - Riesgo: **{row['Prob_Abandono']:.1%}**")
        with col_bottom:
        ...
        # Cálculos avanzados para un resumen más rico
        ...
        # Agrupar por departamento para obtener el peor y el mejor
        if num_empleados > 0:
