    ...
    with tab3:
        ...
        if df_filtered.empty: st.warning("No hay empleados que coincidan con los filtros.")
            ...
            with st.expander("Ver Análisis Detallado de Escenarios y Recomendaciones"):
                ...
                - **¿Por qué funciona?:** Invertir en formación aumenta la motivación y el compromiso.
                ...
                - **¿Por qué funciona?:** Es una palanca potente a corto plazo y una señal de valoración.
                ...
                - **¿Por qué funciona?:** Ataca múltiples frentes de la insatisfacción (desarrollo y compensación).
