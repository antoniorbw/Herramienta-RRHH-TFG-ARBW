...
get_ipython().system('pip install fpdf matplotlib # Ensure fpdf is installed')
...
HTML(df_sim[["Edad", "Departamento", "Prob_Abandono", "Recomendación"]].to_html(index=False))
...
get_ipython().system('pip install fpdf matplotlib')
